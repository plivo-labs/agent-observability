...
export const EXECUTABLE_NODE_TYPES = new Set<string>(["start", "initiate_call", "ai_agent_v2", "ai_agent_v29", "http_request", "branch_v2", "ai_action", "prompt", "contact_screening", "outbound_screening", "agent_node"]);
