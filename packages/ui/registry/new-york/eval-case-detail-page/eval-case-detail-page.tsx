...
function VerdictBanner({ judgment }: { judgment: JudgmentResult }) {
	...
	const reasoning = judgment.reasoning ? trimReasoning(judgment.reasoning) : "";
			...
			<div className="flex items-start gap-2.5">
				<div
					className={cn(
						...
						failed &&
							"border border-[hsl(var(--destructive-border))] bg-[hsl(var(--destructive-bg))] text-[hsl(var(--destructive))]",
						passed &&
							"border border-[hsl(var(--success-border))] bg-[hsl(var(--success-bg))] text-[hsl(var(--success-fg,var(--success)))]",
				...
				<div className="min-w-0 flex-1">
					<div className="flex items-center gap-2 text-s-600 text-foreground">
						...
						{showScoreBadge && (
							<span
								className={cn(
									"inline-flex items-center rounded border px-1.5 py-0.5 text-xxs-600 font-mono",
									failed
