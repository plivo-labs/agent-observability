...
import { computeAvg, computePercentile, formatMs } from '@/lib/observability-format'
...
export const LatencyPercentilesChart = ({ metrics: metricsProp }: { metrics?: SessionMetrics | null }) => {
