...
class SupportAgent extends Agent {
    constructor() {
        super({
            instructions: "You are a support specialist. When the user asks about an order, " +
...
class GreeterAgent extends Agent {
    constructor() {
        super({
            instructions: "You are the front-line greeter. Greet users warmly. " +
                "If they mention an order, call transfer_to_support to hand off.",
            tools: {
                transfer_to_support: tool({
                    description: "Called when the user asks about an order and needs a specialist.",
                    parameters: z.object({}),
    ...
    it("support agent calls lookup_order with correct args", async () => {
        ...
        try {
            ...
            result.expect.nextEvent().isFunctionCallOutput({
                ...
                output: JSON.stringify("Order 12345: shipped on 2026-04-20, arriving 2026-04-23."),
                isError: false,
            });
    ...
    it("handles a missing order without hallucinating", async () => {
        ...
        try {
            ...
            await result.expect
                ...
                .isMessage({ role: "assistant" })
                .judge(model, {
                intent: "The assistant clearly communicates that the order was not " +
    ...
    it("refuses off-task requests", async () => {
        ...
        try {
            ...
            await result.expect
                ...
                .isMessage({ role: "assistant" })
                .judge(model, {
                intent: "The assistant does NOT tell a joke and instead steers the " +
