      ...
      metricsWith({
        voice: {
          dead_air: deadAirBlock({
            count: 1,
            max_ms: DEAD_AIR_SINGLE_MS,
            total_ms: DEAD_AIR_SINGLE_MS,
            events: [{ turn_number: 4, kind: "response", gap_ms: DEAD_AIR_SINGLE_MS }],
          }),
        },
      }),
    );
      ...
      metricsWith({
        voice: {
          dead_air: deadAirBlock({
            ...
            max_ms: 3500,
            total_ms: 3500,
            events: [{ turn_number: 2, kind: "inter_turn", gap_ms: 3500 }],
          }),
        },
      }),
    );
