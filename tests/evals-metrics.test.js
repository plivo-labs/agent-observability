...
import { computeCaseMetrics } from "../src/evals/metrics.js";
import { __setPricesForTesting, __resetPricingForTesting, } from "../src/evals/pricing.js";
describe("computeCaseMetrics", () => {
    ...
    test("malformed events are skipped, not fatal", () => {
        const m = computeCaseMetrics([
            ...
            { type: "message", role: "assistant", metrics: "not-a-dict" },
