...
import { deriveRunStatus, EVAL_RUN_STALE_ACTIVITY_MS, } from "../src/evals/overlay.js";
describe("deriveRunStatus", () => {
    ...
    test("accepts ISO string timestamps", () => {
        ...
        expect(deriveRunStatus("running", "2026-05-14T08:00:00Z", now)).toBe("completed");
        // 30 minutes ago → within the TTL.
        expect(deriveRunStatus("running", "2026-05-14T09:30:00Z", now)).toBe("running");
    });
